...
ᴀʟꜱᴏ ʏᴏᴜ ᴄᴀɴ ᴀꜱᴋ ᴀɴʏᴛʜɪɴɢ ɪɴ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ [❤️](https://telegra.ph/file/7a8fe5e8dba3abf050cf8.jpg)"""

START_IMG = "https://telegra.ph/file/3709ce19e03fd3f31de90.mp4"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [🇮🇳‣✗-𝙲𝙻𝙰𝙽𝙻𝙾𝚁𝙳](t.me/friends_chatting_world) \
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
            START_IMG, caption= "<code>【🇮🇳】𝐓𝐈𝐑𝐀𝐍𝐆𝐀 🇽 𝔹𝕆𝕋【🔱】】 is Here For You❤\nI am Awake Since</code>: <code>{}</code>".format(
                uptime            
            ),
...
def zaid_about_callback(update, context):
    ...
    if query.data == "zaid_":
        query.message.edit_text(
            text=""" ℹ️ I am [【🇮🇳】𝐓𝐈𝐑𝐀𝐍𝐆𝐀 🇽 𝔹𝕆𝕋【🔱】](t.me/tiranga_bot), a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_【🇮🇳】𝐓𝐈𝐑𝐀𝐍𝐆𝐀 🇽 𝔹𝕆𝕋【🔱】licensed under the GNU General Public License v3.0_
                 \n❍ Assistant @tiranga\_captain.
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I am [♡➣𝐓𝐈𝐑𝐀𝐍𝐆𝐀➣♡](t.me/tiranga_bot)
                 \nHere is the [Source Code](https://youtu.be/R4hQ7cjkIeI) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
